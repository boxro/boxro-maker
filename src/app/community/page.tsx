  ...
  const deleteDesign = async () => {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.location.hash) {
        console.log('🗑️ 해시 URL이 있는 상태에서 작품 삭제, 해시 제거 후 리다이렉트');
  ...
  return (
    <CommonBackground>
      <Head>
        ...
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://boxro.kr'}/community`} />
        <meta property="og:image" content={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://boxro.kr'}/og-image.png`} />
        ...
        <meta name="twitter:image" content={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://boxro.kr'}/og-image.png`} />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": `${process.env.NEXT_PUBLIC_SITE_URL || 'https://boxro.kr'}/community`,
              "mainEntity": {
                "@type": "ItemList",
                "name": "박스카 작품들",
