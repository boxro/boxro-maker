          ...
          <div className="mt-10">
            <Card className="bg-transparent border-0 shadow-none transition-all duration-300 overflow-hidden py-5 w-full rounded-2xl">
              <CardContent className="text-center py-12">
                ...
                <p className="text-sm text-white/80">멋진 박스카 도안을 준비하고 있어요!</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <CommonBackground>
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/store">
              <Button className="bg-white border border-gray-300 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 rounded-full px-8 py-3 text-gray-800">
        ...
        <div className="mt-12">
          ...
          <CardHeader className="pt-0">
            <div className="w-full md:w-4/5 mx-auto">
              ...
              <p className="text-[14px] md:text-[14px] text-gray-800 leading-relaxed whitespace-pre-wrap mb-3">{article.summary}</p>
          ...
          <div className="flex justify-between items-center">
            ...
            {isAdmin && (
              <div className="flex gap-3">
                <Link href={`/store/edit/${article.id}`}>
                  <Button 
