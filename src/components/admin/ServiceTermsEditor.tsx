...
import { Save, Eye, History, ArrowLeft, FileText } from 'lucide-react';
...
const ServiceTermsEditor: React.FC<ServiceTermsEditorProps> = ({
  versionId,
  onClose,
  onSave
}) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <Card className="bg-white/95 backdrop-blur-sm border border-white/20">
          <CardHeader>
            <CardTitle className="text-lg">서비스이용약관 내용</CardTitle>
          ...
          <CardContent>
            <div>
              <RichTextEditor
                content={content}
                onChange={setContent}
                placeholder="서비스이용약관의 전체 내용을 작성해주세요..."
              />
            </div>
          </CardContent>
        </Card>
...
export default ServiceTermsEditor;